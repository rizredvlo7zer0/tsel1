...
<input class="input100" type="number" name="msisdn" placeholder="Nomer Hp 628x">
...
<div class="container">
  <form action="/action_page.php">
    <div class="form-group" data-validate="Please enter your msisdn">
      <label for="nomor">Nomor Hp:</label>
      <input class="form-control" type"number" name"msisdn" placeholder="+628x">
    </div>
...
Dor Tsel TPP
    ...
    <center>
<font color="red">Pilih Method</font><br>
...
<div class="container">
  <form action="/action_page.php">
    <div class="form-group" data-validate="Please enter your msisdn">
      <label for="nomor">Nomor Hp:</label>
      <input class="form-control" type="text" value="<?= $_SESSION['msisdn']; ?>" name="phone" disabled>
    </div>
...
<div class="container">
  <form action="/action_page.php">
    <div class="form-group" data-validate="Please enter your msisdn">
      <label for="id">Manual id:</label>
      <input class="form-control" type"number" name"pkgidman" placeholder="pkgid">
    </div>

<input type="hidden" "text" name="transactionid" style="width: 50%;" value="A301180826192021277131740"></input><br>

<!--<input type="submit" name="do" value="BUY_PKG"></input>-->

<button type="submit" name="do" value="BUY_PKG" class="btn btn-default">BELI</button>

<br><br>

<!--<input type="submit" name="do" value="LOGOUT"></input>-->

<button type="submit" name="do" value="LOGOUT" class="btn btn-default">Keluar</button>
